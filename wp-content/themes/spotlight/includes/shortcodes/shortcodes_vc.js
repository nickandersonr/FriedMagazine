		...
		window.VcTrxColumnItemView = vc.shortcode_view.extend({
			changeShortcodeParams:function (model) {
				...
				if (_.isObject(params) && _.isString(params.span)) {
					this.$el.removeClass('trx_columns_span_2 trx_columns_span_3 trx_columns_span_4 trx_columns_span_5 trx_columns_span_6');
		...
		if (typeof(window.VcAccordionView) != 'undefined') {
			window.VcTrxAccordionView = window.VcAccordionView.extend({
				addTab:function (e) {
					...
					vc.shortcodes.create({shortcode:'accordion_item', params:{title:tab_title, id:tab_id}, parent_id:this.model.id});
				}
			});
			window.VcTrxAccordionTabView = window.VcAccordionTabView.extend({
				events:{
					'click > .vc_controls .column_delete,.wpb_accordion_item > .vc_controls .vc_control-btn-delete':'deleteShortcode',
					'click > .vc_controls .column_add,.wpb_accordion_item > .vc_controls .vc_control-btn-prepend':'addElement',
					'click > .vc_controls .column_edit,.wpb_accordion_item > .vc_controls .vc_control-btn-edit':'editElement',
					'click > .vc_controls .column_clone,.wpb_accordion_item > .vc_controls .vc_control-btn-clone':'clone',
		...
		if (typeof(window.VcAccordionView) != 'undefined') {
			window.VcTrxListView = window.VcAccordionView.extend({
				addTab:function (e) {
					...
					vc.shortcodes.create({shortcode:'list_item', params:{title:tab_title, id:tab_id}, parent_id:this.model.id});
				}		
			});
			window.VcTrxListItemView = window.VcAccordionTabView.extend({
				events:{
					'click > .vc_controls .column_delete,.wpb_list_item > .vc_controls .vc_control-btn-delete':'deleteShortcode',
					'click > .vc_controls .column_add,.wpb_list_item > .vc_controls .vc_control-btn-prepend':'addElement',
					'click > .vc_controls .column_edit,.wpb_list_item > .vc_controls .vc_control-btn-edit':'editElement',
					'click > .vc_controls .column_clone,.wpb_list_item > .vc_controls .vc_control-btn-clone':'clone',
					'click > [data-element_type] > .wpb_element_wrapper > .vc_empty-container':'addToEmpty'
				}
			});
		}
		...
		if (typeof(window.VcAccordionView) != 'undefined') {
			window.VcTrxTogglesView = window.VcAccordionView.extend({
				addTab:function (e) {
					...
					vc.shortcodes.create({shortcode:'toggles_item', params:{title:tab_title, id:tab_id}, parent_id:this.model.id});
				}		
			});
			window.VcTrxTogglesTabView = window.VcAccordionTabView.extend({
				events:{
					'click > .vc_controls .column_delete,.wpb_toggles_item > .vc_controls .vc_control-btn-delete':'deleteShortcode',
					'click > .vc_controls .column_add,.wpb_toggles_item > .vc_controls .vc_control-btn-prepend':'addElement',
					'click > .vc_controls .column_edit,.wpb_toggles_item > .vc_controls .vc_control-btn-edit':'editElement',
					'click > .vc_controls .column_clone,.wpb_toggles_item > .vc_controls .vc_control-btn-clone':'clone',
					'click > [data-element_type] > .wpb_element_wrapper > .vc_empty-container':'addToEmpty'
				}
			});
		}
...
function themerex_vc_columns_width(columns) {
	...
	var c = '';
	if (count > 0) 
		columns.removeClass('trx_columns_count_1 trx_columns_count_2 trx_columns_count_3 trx_columns_count_4 trx_columns_count_5 trx_columns_count_6').addClass('trx_columns_count_'+count);
	else {
