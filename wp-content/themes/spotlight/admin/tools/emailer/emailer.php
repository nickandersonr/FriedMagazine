...
class TRX_Emailer {
	...
	function admin_menu_item() {
		$menu_page = add_management_page(__('Emailer', 'themerex'), __('Emailer', 'themerex'), 'manage_options', 'trx_emailer', array($this, 'build_page'));
	}
	...
	function load_styles() {
		if (isset($_REQUEST['page']) && $_REQUEST['page']=='trx_emailer') {
			wp_enqueue_style('trx-emailer-style', get_template_directory_uri() . '/admin/tools/emailer/emailer.css', array(), null);
		}
	}
	...
	function load_scripts() {
		if (isset($_REQUEST['page']) && $_REQUEST['page']=='trx_emailer') {
			...
			wp_enqueue_script('trx-emailer-script', get_template_directory_uri() . '/admin/tools/emailer/emailer.js', array('jquery'), null, true);
		}
	}
					...
					<fieldset class="trx_emailer_block_inner">
						...
						<div class="trx_emailer_fields">
							<div class="trx_emailer_field trx_emailer_subject">
								...
								<input type="text" value="<?php echo $subject; ?>" name="emailer_subject" id="emailer_subject" />
							</div>
					...
					<fieldset class="trx_emailer_block_inner">
						...
						<div class="trx_emailer_fields">
							...
							<div class="trx_emailer_field trx_emailer_sender_name">
								...
								<input type="text" name="emailer_sender_name" id="emailer_sender_name" value="<?php echo $sender_name; ?>" /><br />
							</div>
							<div class="trx_emailer_field trx_emailer_sender_email">
								<label for="emailer_sender_email"><?php _e('Sender email:', 'themerex'); ?></label>
								<input type="text" name="emailer_sender_email" id="emailer_sender_email" value="<?php echo $sender_email; ?>" />
							</div>
						</div>
					</fieldset>
				</div>
