...
define( 'NOTIFIER_THEME_NAME', 'Spotlight' ); // The theme name
define( 'NOTIFIER_THEME_FOLDER_NAME', 'spotlight' ); // The theme folder name
define( 'NOTIFIER_XML_FILE', 'http://themerex.net/!updates/updates_spotlight.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
?>
	...
	<div class="wrap">
		...
		<div><img style="margin: 0 0 20px 0; border: 1px solid #ddd;" src="<?php echo get_template_directory_uri( 'template_url' ) . '/screenshot.png'; ?>" /></div>
