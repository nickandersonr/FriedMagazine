...
<article class="isotopeElement post divider <?php 
	...
	if (!$post_data['post_protected']) {
		if (!empty($opt['dedicated'])) {
			...
			echo getVideoFrame($post_data['post_video'], $post_data['post_thumb'], false, '', 'small');
	...
	<header class="post_info infoPost">
		...
		<?php if ($post_data['post_categories_links_colored']!='') { ?>
			<span class="post_cats colored"> <?php echo $post_data['post_categories_links_colored']; ?></span>
		<?php } ?>
