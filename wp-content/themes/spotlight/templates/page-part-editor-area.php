...
if ($post_data['post_edit_enable']) {
	...
	wp_enqueue_style( 'fontello-admin',         themerex_get_file_url('/admin/css/fontello/css/fontello-admin.css'), array(), null);
	wp_enqueue_style ( 'frontend-editor-style', themerex_get_file_url('/js/editor/_editor.css'), array('main-style'), null );
	wp_enqueue_script( 'frontend-editor',       themerex_get_file_url('/js/editor/_editor.js'),  array(), null, true );
	...
	?>
	<a href="#" id="frontend_editor_icon_edit" class="sc_button style_border size_big type_rounded trex_accent_bg_color">edit</a>
	<div id="frontend_editor">
		<div id="frontend_editor_inner">
			...
			<script type="text/javascript">
				...
				var THEMEREX_EDITOR_ajax_url   = "<?php echo $ajax_url; ?>";
